    ...
    public function handle()
    {
        try {
            ...
            if (is_array($columns) and count($columns) > 0) {
                ...
                $this->info('No se encontro la tabla: ' . Str::plural(strtolower($this->camelToUnderscore($name, '_', true))));
                die();
            }
...
//        $imputs = "";
    ...
    protected function createAndEdit($name, $columns)
    {
        ...
        foreach ($filter_columns as $key => $item) {
            ...
            @include('global.input-b',[
                ...
                'icon' => null,
                'col' => 6,
                'value' => isset($$name) && $$name != null ? $$name: null,
                'default' => null,
                'display' => null,
                'selected_value' => null,
                'multiple' => null,
    ...
    {
        $fieldAndTypeList = [];
        $tableName = Str::plural(strtolower($tableName));
